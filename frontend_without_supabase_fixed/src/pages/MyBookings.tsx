        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Enter your email address to view your flight reservations
            </p>
          </div>

          <Card className="bg-gradient-card shadow-card max-w-md mx-auto">
      ...
      <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-semibold mb-2">Loading Bookings...</h2>
          </div>
        </div>
      </div>
    );
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">
              No flight bookings found for {searchEmail}.
            </p>
